...
function history() {
    ...
    document.getElementsByClassName('df')[document.getElementsByClassName('df').length - 1].innerHTML = "<a href='index.html' style='color: #8f8f8f;text-decoration: none' href=''>see repository</a>";
}
