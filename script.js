...
function history() {
    ...
    document.getElementsByClassName('df')[document.getElementsByClassName('df').length - 1].innerHTML = "<a style='color: #8f8f8f;text-decoration: none' href='https://github.com/ha8540268/professional_calculator'>see repository</a>";
}
